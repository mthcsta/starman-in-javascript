...
mapa = `
CCCCCCCC                                                                                                                                                                                                                                               CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                                                            CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
        CCCCCCCCCCCCCCC                                                                                                                                                                                          CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                CCCCCCCCCCCCCCCCCCCCCCCCCCC                                                C                                                            
                       CCCCCCCCCCCCCCCCC                                                                                                                                                                      CCC                                                                                                 CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                                             
...
CCCCCCCCCCCCCCCCCC                                                                                                                                                                                     CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                   CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
                  CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                                                                                                                                    C                                                                                                                    CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                                                 
                                                  C                                                                                                                                                  C                                                                                                                                                                                                                         
                                                  CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                                         CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC                                                                                                                                                                                                                          
...
canvas.style.border = "2px solid orangered";
...
function gotoxy(letter, x, y){
	...
	var ctext = letter;
	context.fillText(ctext, x*9, (y+2)*14);
}
...
function partida(){
    ...
    if(ponteiro.partidaStatus == "requisitar"){
        ...
        fopen(ponteiro.nivel, function(){  }, function(){ TELA = "creditos"; });
...
function deletaInimigo(indice){
    inimigo[indice] = inimigo[ponteiro.inimigos_existentes];
    ponteiro.inimigos_existentes--;
}
